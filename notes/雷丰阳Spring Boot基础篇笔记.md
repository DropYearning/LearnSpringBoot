...
- **Docker**是一个开源的应用容器引擎；是一个轻量级容器技术；性能高于传统虚拟机
...
![Y24Q7FY](https://i.imgur.com/Y24Q7FY.png)
...
- 使用Docker的步骤：
    ...
    - 3）、使用Docker运**行这个镜像，这个镜像就会生成一个Docker容器**；
...
![vEwzhZD](https://i.imgur.com/vEwzhZD.png)
...
> 做端口映射时，前一个端口是Host的端口，后一个端口是Container的端口
